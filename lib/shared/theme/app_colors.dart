...
class AppColors {
  ...
  static const Color lightSkyBlue = Color.fromARGB(255, 95, 173, 255); // สีเทาอ่อน
  ...
  static const Color backgroundContainerDark =  Color.fromARGB(255, 49, 120, 195);
  static const Color backgroundContainerLight = Color(0xFFBDBDBD); // สีพื้นหลัง��ทนสีขา��
